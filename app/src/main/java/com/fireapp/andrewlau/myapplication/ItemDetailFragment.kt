...
class ItemDetailFragment : Fragment() {
     ...
     */
    private var item: ALauDatastore.DrawItem? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        arguments?.let {
            if (it.containsKey(ARG_ITEM_ID)) {
                ...
                item = ALauDatastore.ITEM_MAP[it.getString(ARG_ITEM_ID)]
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        item?.let {
            ...
            rootView.medium.text = it.medium
            rootView.action.text = it.action
            rootView.definition.text = it.definition + "%"
        }
